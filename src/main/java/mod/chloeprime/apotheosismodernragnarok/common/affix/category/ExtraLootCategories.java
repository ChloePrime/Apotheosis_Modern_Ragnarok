...
public class ExtraLootCategories {
    ...
    public static Supplier<LootCategory> FULL_AUTO = register("full_auto", 700, GunPredicate.effectiveFullAuto(), ALObjects.EquipmentSlotGroups.MAINHAND);
    public static Supplier<LootCategory> SEMI_AUTO = register("semi_auto", 800, GunPredicate.supports(FireMode.SEMI, FireMode.BURST), ALObjects.EquipmentSlotGroups.MAINHAND);
